...
def on_failure_callback_dag(context):
    ...
    for ti in task_instances:
        ...
        data = requests.get("https://ee5d6852891701.eastus.airflow.svc.datafactory.azure.com//api/v1/dags/dag_with_templated_dir/dagRuns/manual__2023-12-04T11:47:36.416879+00:00/taskInstances/my_task/logs/1?full_content=false",auth=("admin", "1234"))
        print(data)
